...
os.chdir(r'C:\Users\SAMSUNG\Downloads\Graphene-RL')
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
         for i, (img, label) in enumerate(test_dataloader):
            ...
            labels[start_idx:end_idx] = np.squeeze(np.squeeze(label))
            start_idx = end_idx
...
if __name__ == "__main__":
    ...
    model_dir='./models'
    resnet.load_state_dict(torch.load(os.path.join(model_dir, 'resnet_flux.ckpt')),map_location=device)
    mlp.load_state_dict(torch.load(os.path.join(model_dir, 'mlp_flux.ckpt')), map_location=device)
    #=============================================================================================================================================================================
